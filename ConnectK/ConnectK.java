...
//			System.out.println("Starting GC at time: " + (System.currentTimeMillis() - begin));
//			if(view != null)
//				view.setStatus("Waiting on GC");
//			Runtime.getRuntime().gc();
//			System.out.println("GC finished at: " + (System.currentTimeMillis() - begin));
//			if(view != null)
//				view.setStatus("Waiting for player " + currentPlayer);
		...
		if(view != null){
			if(currentBoard.winner() != 0){
				...
				view.highlightSpaces(currentBoard.winningSpaces());
			}
			if(!currentBoard.hasMovesLeft()){
				view.setStatus("Draw");
			}
		}
		System.out.println("Player " + currentBoard.winner() + " wins!");
